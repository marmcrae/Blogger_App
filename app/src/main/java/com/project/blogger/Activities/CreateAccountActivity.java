            ...
            mAuth.createUserWithEmailAndPassword(em, pwd).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    ...
                    if(authResult !=null) {
                        ...
                        mFirebaseStorage.child("MBlog_Profile_Pics").child(resultUri.getLastPathSegment());
                        mFirebaseStorage.putFile(resultUri).addOnSuccessListener (new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            @Override
